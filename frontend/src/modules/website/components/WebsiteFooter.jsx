        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/company/creditu-technologies-private-limited" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all">
                <Linkedin size={18} />
              </a>
            </div>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-primary font-black uppercase tracking-widest text-sm mb-6">Contact Us</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <ul className="space-y-6">
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs font-black uppercase tracking-widest text-slate-400 mb-1">Corporate Inquiry</p>
              ...
              <ul className="space-y-6">
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs font-black uppercase tracking-widest text-slate-400 mb-1">Grievance Redressal Officer</p>
